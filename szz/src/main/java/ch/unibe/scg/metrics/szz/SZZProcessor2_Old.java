...
public class SZZProcessor2_Old implements CommitVisitor {

	private static final int MAX_MODIFICATIONS = 10;
	
	private SZZRepository repository;
	
	private Logger logger = Logger.getLogger(SZZProcessor2_Old.class);
	
	public SZZProcessor2_Old(SZZRepository repository) {
